...
const INTENTIONAL = /^(FAQ|Portfolio|TripleZero|TripleZero iT|WordPress|WooCommerce|AI|AEO|GEO|SEO|Enterprise|Business|Support|Chatbots|Workflows|Webdesign|Webhosting|E-commerce|Marketing|Social Media|Printing|Digital Design|Digital design|Contact|Account|Home|Login|CRM|Extra Growth|Custom|Newsletter|Cookies|Force majeure|Privacy|Download|Name|Basic Support|Premium Support|Standard Support|Plan highlights|VPS Hosting.*|Shared Hosting.*|WordPress Hosting.*|WordPress Support|Social Media Management|Community Management|24\/7 support|Fix website errors|Fix Bugs and Errors)$/i;
