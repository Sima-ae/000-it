...
> = {
  ...
  "ai-scan-starten": { c1: "#5e3b88", c2: "#007c8d", motif: "bot" },
  "ai-scan-scores": { c1: "#5e3b88", c2: "#9b7fc0", motif: "bot" },
  "ai-scan-verbeteren": { c1: "#5e3b88", c2: "#007c8d", motif: "bot" },
  "ai-scan-dashboard": { c1: "#5e3b88", c2: "#2f3a48", motif: "bot" },
  "ai-scan-oplossingen": { c1: "#5e3b88", c2: "#007c8d", motif: "globe" },
  ...
  "microsoft-teams": { c1: "#5e3b88", c2: "#6264a7", motif: "bot" },
  "microsoft-onedrive": { c1: "#0078d4", c2: "#5e3b88", motif: "doc" },
  "microsoft-beheer": { c1: "#5e3b88", c2: "#2f3a48", motif: "server" },
  "microsoft-beveiliging": { c1: "#5e3b88", c2: "#e11d48", motif: "shield" },
  ...
  "aeo-antwoordengines": { c1: "#5e3b88", c2: "#007c8d", motif: "globe" },
  "geo-lokaal": { c1: "#007c8d", c2: "#5e3b88", motif: "globe" },
  "seo-klassiek": { c1: "#5e3b88", c2: "#2f3a48", motif: "globe" },
  "aeo-geo-seo-trajecten": { c1: "#5e3b88", c2: "#9b7fc0", motif: "globe" },
  "aeo-geo-seo-resultaten": { c1: "#5e3b88", c2: "#007c8d", motif: "doc" },
  "bloggen-starten": { c1: "#5e3b88", c2: "#9b7fc0", motif: "doc" },
  "bloggen-schrijven": { c1: "#5e3b88", c2: "#007c8d", motif: "doc" },
  "bloggen-vormgeving": { c1: "#5e3b88", c2: "#9b7fc0", motif: "doc" },
  "bloggen-groei": { c1: "#5e3b88", c2: "#007c8d", motif: "doc" },
  "bloggen-beheer": { c1: "#5e3b88", c2: "#2f3a48", motif: "doc" },
  "cyberpanel-starten": { c1: "#007c8d", c2: "#5e3b88", motif: "server" },
  "cyberpanel-websites": { c1: "#007c8d", c2: "#9b7fc0", motif: "server" },
  "cyberpanel-email-dns": { c1: "#007c8d", c2: "#5e3b88", motif: "mail" },
  "cyberpanel-ssl-beveiliging": { c1: "#007c8d", c2: "#e11d48", motif: "shield" },
  "cyberpanel-bestanden-databases": { c1: "#007c8d", c2: "#2f3a48", motif: "server" },
  "cyberpanel-php-ols": { c1: "#007c8d", c2: "#5e3b88", motif: "server" },
};
