  ...
  categories: [
    {
      ...
      items: [
        ...
        q("alg-7", "Hoe snel kunnen u starten?", "Afhankelijk van capaciteit vaak binnen enkele werkdagen na akkoord. Spoedtrajecten (bugs, malware, downtime) prioriteren we."),
        q("alg-8", "Werken wij remote of on-site?", "Primair remote, met duidelijke communicatie via mail, chat en calls. On-site is op verzoek bespreekbaar."),
        ...
        q("alg-10", "Wat hebben u nodig om te starten?", "Toegang tot website/hosting (indien nodig), doelen, merkrichtlijnen, analytics-accounts en eventuele bestaande tools."),
        q("alg-11", "Zijn u diensten geschikt voor startups?", "Ja. We schalen van lean landingspagina’s en AI-scans tot volledige groei-setups wanneer u groeit."),
        ...
        q("alg-13", "Kunnen wij bestaande leveranciers overnemen of samenwerken?", "Ja. We werken soepel naast developers, marketeers of agencies, of nemen onderhoud en optimalisatie over."),
      ],
    },
    {
      id: "ai",
      title: "AI",
      items: [
        q("ai-1", "Wat is een AI-scan bij TripleZero iT?", "Een AI-readiness scan beoordeelt hoe goed uw site vindbaar is voor klassieke zoekmachines, AI-antwoorden én lokale/geografische zoekresultaten (AEO, GEO, SEO en technische basis)."),
        q("ai-2", "Wat meet de AI-scan precies?", "Onder meer AEO-signalen, GEO/lokale vindbaarheid, SEO-fundamentals, contentstructuur, performance-indicaties en AI-readiness — met scores en verbeterpunten."),
        ...
        q("ai-5", "Kunnen wij AI in onze workflow integreren?", "Ja: content-assistentie, automatisering, chatbot/ticket flows, data-koppelingen en maatwerk API’s rond AI-tools."),
        q("ai-6", "Vervangt AI u strategisch werk?", "Nee. AI versnelt analyse en productie; strategie, merktoon en conversiebeslissingen blijven menselijk en meetbaar."),
        ...
        q("ai-9", "Kunnen wij AI-agents in het dashboard inzetten?", "Ja. In het klantportaal ziet u AI-agents voor o.a. SEO, content, social en ads — met status en taken."),
        q("ai-10", "Werken wij met ChatGPT, Claude of andere tools?", "We kiezen tools per use-case. Belangrijk is governance: bronnen, factcheck, merkrichtlijnen en privacy."),
    ...
    },
    {
      ...
      items: [
        ...
        q("seo-2", "Waarom is AEO/GEO nu belangrijk?", "Steeds meer zoekers krijgen antwoorden via AI én zoeken lokaal (“bij mij in de buurt”). Zonder AEO mist u AI-citaties; zonder GEO mist u lokale leads — ook als klassieke SEO goed is."),
        q("seo-3", "Hoe starten u een SEO-traject?", "Met technische audit, keyword/intent-onderzoek, contentgap-analyse en een prioriteitenroadmap gekoppeld aan business-KPI’s."),
        ...
        q("seo-5", "Doen wij ook lokale SEO?", "Ja: Google Business Profile, lokale landingspagina’s, NAP-consistentie, reviews en lokale contentclusters."),
        q("seo-6", "Wat is technical SEO bij u?", "Crawlability, indexatie, Core Web Vitals, structured data, sitemap/robots, canonicals, interne linking en foutopsporing."),
        q("seo-7", "Helpen wij met content voor SEO?", "Ja: briefings, outlines, blogs, landingspagina’s en FAQ’s die intent matchen én AI-vriendelijk gestructureerd zijn."),
        ...
        q("seo-9", "Doen wij linkbuilding?", "Ja, ethisch en relevant: digitale PR, partnerships, content assets. Geen spammy linkschemas."),
        q("seo-10", "Kunnen wij bestaande SEO-schade herstellen?", "Ja: recovery na updates, toxic links, indexatieproblemen of content-cannibalization."),
        q("seo-11", "Hoe rapporteren u SEO-voortgang?", "Maandelijks of per sprint: rankings, traffic, conversies, technische issues en next actions."),
        ...
        q("seo-14", "Helpen wij met internationale SEO?", "Ja: hreflang, marktonderzoek per land/taal, contentlokalisatie en technische multi-locale setups."),
      ],
    },
    {
      id: "adverteren",
      title: "Adverteren",
      items: [
        q("ads-1", "Welke advertentiekanalen ondersteunen u?", "Google Ads, Meta (Facebook/Instagram), LinkedIn, en waar relevant YouTube/retargeting — afgestemd op funnel en budget."),
        q("ads-2", "Hoe bepalen u het juiste advertentiebudget?", "Op basis van doelen (leads/sales), CAC-doel, marktprijzen en testfase. We starten lean en schalen wat werkt."),
        q("ads-3", "Wat is u aanpak voor Google Ads?", "Accountstructuur, zoekintentie, negatieve keywords, landingpage-fit, conversietracking en wekelijkse optimalisatie."),
        q("ads-4", "Kunnen wij Meta Ads voor e-commerce draaien?", "Ja: catalogus/retargeting, creatives, audiences en creatieve tests om ROAS te verbeteren."),
        q("ads-5", "Hoe meten u advertentie-succes?", "Via conversies, CPA/CAC, ROAS, leadkwaliteit en pipeline — niet alleen klikken."),
        ...
        q("ads-7", "Doen wij ook B2B LinkedIn Ads?", "Ja, met scherpe targeting, leadgen-forms of landingspagina’s en content die decision-makers aanspreekt."),
        ...
        q("ads-9", "Maken u ook ads creatives?", "Ja: copy, visuals en varianten voor tests. Design en media-creatie kunnen we meenemen."),
        ...
        q("ads-11", "Beheren u bestaande ad-accounts?", "Ja. We auditen, herstructureren en optimaliseren zonder onnodig opnieuw te beginnen."),
        q("ads-12", "Hoe voorkomen u verspild ad-budget?", "Negatieven, audience exclusions, budget caps, geofencing, frequency control en snelle kill van underperformers."),
    ...
    },
    {
      ...
      title: "Design",
      items: [
        q("des-1", "Welke design-diensten bieden u?", "Logo’s, merkidentiteit, visitekaartjes, briefpapier, flyers, posters, stickers, magazines/brochures en digitale visuals."),
        q("des-2", "In welke tools werken u?", "Adobe Photoshop, Illustrator en InDesign — zodat bestanden drukkerij-klaar en professioneel uitwisselbaar zijn."),
        q("des-3", "Leveren wij drukklare bestanden?", "Ja: CMYK, bleed, snijmerken en juiste PDF/X-export waar nodig, plus screen-varianten."),
        ...
        q("des-5", "Kunnen wij ons bestaande merk updaten?", "Ja: refresh van logo, kleur, typografie en toepassingen zonder de herkenning te breken."),
        q("des-6", "Maken u ook social templates?", "Ja, consistente templates voor posts/stories/ads zodat uw team snel kan publiceren."),
        ...
        q("des-8", "Kunnen wij magazines of brochures opmaken?", "Ja, meerpagina-layouts in InDesign met grid, stijlen en prepress-checks."),
        q("des-9", "Helpen wij met drukwerk?", "Ja. We ontwerpen én kunnen drukken in kleine of grote oplages — van visitekaartjes en stickers tot flyers, posters en brochures — met proofs en afstemming."),
    ...
    },
    {
      ...
      title: "Marketing",
      items: [
        q("mkt-1", "Welke marketingdiensten bieden u?", "AEO/GEO/SEO, content, social, ads, e-commerce groei, product listing, community management en data entry."),
        q("mkt-2", "Hoe maken u een marketingstrategie?", "Doelen, audience, positionering, kanalenmix, contentpijplijn en KPI’s — pragmatisch en uitvoerbaar."),
        q("mkt-3", "Wat is full-funnel marketing bij u?", "Van awareness (content/ads) via overweging (cases/SEO) tot conversie (landingspagina’s/CRM) en retentie."),
        q("mkt-4", "Helpen wij met positionering?", "Ja. Heldere positionering voorkomt versnipperde campagnes en zwakke conversie."),
        q("mkt-5", "Kunnen wij content writing leveren?", "Ja: blogs, website copy, newsletters, landingspagina’s en sales copy — SEO- én conversiegericht."),
        q("mkt-6", "Doen wij e-commerce marketing?", "Ja: productfeeds, listing quality, CRO, ads en SEO voor categorieën/producten."),
        q("mkt-7", "Wat is CRO?", "Conversion Rate Optimization: verbeteren van pagina’s, funnels en UX zodat meer bezoekers converteren."),
        q("mkt-8", "Hoe rapporteren u marketingresultaten?", "Dashboards/rapporten met traffic, leads, sales, CPA/ROAS en learnings per kanaal."),
        q("mkt-9", "Werken wij met ons interne marketingteam?", "Ja. We kunnen uitvoeren, sparren of een specialistisch deel overnemen (bijv. alleen SEO of alleen ads)."),
        q("mkt-10", "Hoe snel starten u campagnes?", "Na tracking/setup vaak binnen 1–2 weken live; contenttrajecten lopen parallel."),
        q("mkt-11", "Helpen wij met e-mailmarketing?", "Ja: flows, nieuwsbrieven en copy. Integratie met CRM/e-commerce is mogelijk."),
        ...
        q("mkt-13", "Hoe voorkomen u “busy marketing” zonder resultaat?", "Elke activiteit hangt aan KPI’s. Underperforming tactieken stoppen we of verbeteren we met data."),
      ],
    },
    {
      id: "social-media",
      title: "Social Media",
      items: [
        q("soc-1", "Welke social kanalen beheren u?", "Vooral LinkedIn, Instagram, Facebook, en waar relevant X/TikTok — op basis van audience, niet van hype."),
        ...
        q("soc-3", "Maken u ook de visuals en video’s?", "Ja, via media creation: stilstaand, carrousels, short-form video en templates."),
        q("soc-4", "Hoe vaak posten u?", "Afhankelijk van kanaal en doelen — typisch 3–5×/week per kernkanaal, met kwaliteit boven volume."),
        q("soc-5", "Helpen wij met community management?", "Ja: moderatie, reacties, DM’s en reputatiezorg volgens afgesproken tone-of-voice."),
        ...
        q("soc-7", "Hoe meten u social succes?", "Bereik, engagement, click-outs, leads en assisted conversions — niet alleen likes."),
        q("soc-8", "Werken wij met influencers?", "Op verzoek: selectie, briefing en tracking. We focussen op fit en meetbare outcomes."),
        q("soc-9", "Kunnen wij crisiscommunicatie ondersteunen?", "Ja, met snelle response-protocollen en afstemming met uw team."),
        q("soc-10", "Helpen wij LinkedIn voor B2B thought leadership?", "Ja: persoonlijke + company content, carrousels, cases en employee advocacy."),
        q("soc-11", "Leveren wij een contentkalender?", "Ja, maand- of kwartaalplanning met thema’s, formats en deadlines."),
    ...
    },
    {
      ...
      title: "Support",
      items: [
        q("sup-1", "Welke support bieden u?", "WordPress-support, maatwerk website-support, tickets/live chat, onderhoud, security, performance en incident response."),
        ...
        q("sup-3", "Wat is u responstijd?", "We mikken op snelle eerste response (vaak binnen één werkdag; kritieke downtime sneller). Exacte SLA’s in supportpakketten."),
        q("sup-4", "Bieden wij 24/7 monitoring?", "Ja in relevante support-/hostingpakketten: monitoring, backups en alerts."),
        q("sup-5", "Kunnen wij malware verwijderen?", "Ja — zowel WordPress als maatwerk stacks — inclusief harden en nazorg."),
        q("sup-6", "Doen wij WordPress updates voor ons?", "Ja, via “Onderhoud en updates”: core/plugins/themes met backup en checks."),
        q("sup-7", "Helpen wij bij hostingproblemen?", "Ja. We diagnosticeren, migrieren of optimaliseren hosting/VPS/domeinen."),
        ...
        q("sup-12", "Helpen wij ook niet-technische vragen?", "Ja, over diensten, facturatie en account. Technische diepgang hangt af van uw pakket."),
    ...
    },
    {
      ...
      title: "Webdesign",
      items: [
        q("web-1", "Bouwen u alleen WordPress-sites?", "Nee. Naast WordPress doen we maatwerk webdesign in HTML/CSS/JS, PHP en Next.js — los van WordPress-diensten."),
        ...
        q("web-3", "Kunnen wij een bestaande site redesignen?", "Ja: UX/UI refresh, conversieverbetering en technische modernisering zonder alles weg te gooien."),
        q("web-4", "Werken wij met Next.js?", "Ja. Next.js is ideaal voor snelle, SEO-klare marketing sites en dashboards."),
        q("web-5", "Doen wij ook PHP-applicaties?", "Ja: portals, API’s, legacy modernisering en performance/security hardening."),
        q("web-6", "Hoe zorgen u voor mobiele websites?", "Mobile-first design, responsive layouts en tests op gangbare devices/browsers."),
        ...
        q("web-8", "Kunnen wij CMS-opties bieden zonder WordPress?", "Ja: headless CMS, custom admin of statische setups — afhankelijk van uw team."),
        ...
        q("web-10", "Regelen u ook copy en SEO bij launch?", "Ja, in combinatie met content/SEO-diensten zodat de site meteen vindbaar en conversiegericht is."),
        ...
        q("web-12", "Kunnen wij API’s koppelen (CRM, betalingen, AI)?", "Ja. Integraties met nette foutafhandeling, logging en documentatie."),
        q("web-13", "Hoe leveren u code op?", "Via repository/deploy pipeline waar mogelijk, met environments (staging/production) en handover."),
        q("web-14", "Helpen wij met conversie-optimalisatie op de site?", "Ja: A/B-tests, UX-verbeteringen, formulieren, CTA’s en page speed."),
      ],
    },
    {
      id: "webhosting",
      ...
      items: [
        q("host-1", "Welke hosting bieden u?", "Shared hosting, WordPress hosting en VPS — in Basic/Plus/Business niveaus, plus domeinen."),
        ...
        q("host-3", "Helpen wij met domeinregistratie?", "Ja. We adviseren, registreren/verhuizen en koppelen DNS correct."),
        q("host-4", "Zit SSL bij hosting?", "Ja, SSL is standaard in onze relevante hostingplannen."),
        q("host-5", "Kunnen wij mijn site migreren naar u hosting?", "Ja: backup, migratie, DNS-cutover, SSL en smoke tests met minimale downtime."),
        ...
        q("host-8", "Bieden wij e-mail bij domeinen?", "Dat hangt van het pakket/setup af. We adviseren betrouwbare mailoplossingen en DNS (SPF/DKIM/DMARC)."),
        q("host-9", "Hoe veilig is u hosting?", "Firewall/SSL, updates, monitoring en hardening. Security-diensten kunnen extra lagen toevoegen."),
        q("host-10", "Kan ik later van shared naar VPS?", "Ja. Migratie plannen we met u, inclusief tests en rollback."),
        q("host-11", "Ondersteunen wij CDN?", "Ja, waar relevant (vaak gratis CDN in WP-hostingplannen) voor snellere globale delivery."),
        q("host-12", "Wat is u uptime-aanpak?", "Monitoring, snelle incident response en duidelijke communicatie bij onderhoudsvensters."),
        q("host-13", "Helpen wij DNS-problemen oplossen?", "Ja: records, propagatie, mail-auth en domeinkoppelingen."),
