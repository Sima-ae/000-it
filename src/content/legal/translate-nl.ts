...
const EXACT: Record<string, string> = {
  ...
  '9. Your rights with respect to personal data': '9. Jouw rechten met betrekking tot persoonsgegevens',
  ...
  '7.1 Manage your consent settings': '7.1 Beheer jouw toestemmingsinstellingen',
  Usage: 'Gebruik',
  ...
  'You have the right to know why your personal data is needed, what will happen to it, and how long it will be retained for.':
    'Je hebt het recht te weten waarom jouw persoonsgegevens nodig zijn, wat ermee gebeurt en hoe lang zij worden bewaard.',
  'Right of access: You have the right to access your personal data that is known to us.':
    'Recht op inzage: je hebt het recht inzage te krijgen in jouw persoonsgegevens die bij ons bekend zijn.',
  'Right to rectification: you have the right to supplement, correct, have deleted or blocked your personal data whenever you wish.':
    'Recht op rectificatie: je hebt het recht jouw persoonsgegevens aan te vullen, te corrigeren, te laten verwijderen of te laten blokkeren wanneer je dat wenst.',
  'If you give us your consent to process your data, you have the right to revoke that consent and to have your personal data deleted.':
    'Als je ons toestemming geeft om jouw gegevens te verwerken, heb je het recht die toestemming in te trekken en jouw persoonsgegevens te laten verwijderen.',
  'Right to transfer your data: you have the right to request all your personal data from the controller and transfer it in its entirety to another controller.':
    'Recht op overdracht van jouw gegevens: je hebt het recht al jouw persoonsgegevens bij de verwerkingsverantwoordelijke op te vragen en deze in hun geheel over te dragen aan een andere verwerkingsverantwoordelijke.',
  'Right to object: you may object to the processing of your data. We comply with this, unless there are justified grounds for processing.':
    'Recht van bezwaar: je kunt bezwaar maken tegen de verwerking van jouw gegevens. Wij voldoen hieraan, tenzij er gerechtvaardigde gronden voor de verwerking zijn.',
  'You have the following rights with respect to your personal data:':
    'Je hebt de volgende rechten met betrekking tot jouw persoonsgegevens:',
  'For questions and/or comments about our Cookie Policy and this statement, please contact us by using the following contact details:':
    'Voor vragen en/of opmerkingen over ons cookiebeleid en deze verklaring kun je contact met ons opnemen via de volgende contactgegevens:',
...
const PARTIAL: [RegExp, string][] = [
  [
    ...
    'Onze website, https://000-it.com (hierna: “de website”) maakt gebruik van cookies en andere gerelateerde technologieën (voor het gemak worden alle technologieën aangeduid als “cookies”). Cookies worden ook geplaatst door derden die wij hebben ingeschakeld. In het onderstaande document informeren wij je over het gebruik van cookies op onze website.',
  ],
  [
    /^A cookie is a small simple file that is sent along with pages of this website and stored by your browser on the hard drive of your computer or another device\. The information stored therein may be returned to our servers or to the servers of the relevant third parties during a subsequent visit\.$/,
    'Een cookie is een klein eenvoudig bestand dat meegestuurd wordt met pagina’s van deze website en door jouw browser wordt opgeslagen op de harde schijf van jouw computer of een ander apparaat. De daarin opgeslagen informatie kan bij een volgend bezoek naar onze servers of naar de servers van de betreffende derden worden teruggestuurd.',
  ],
  [
    /^A script is a piece of program code that is used to make our website function properly and interactively\. This code is executed on our server or on your device\.$/,
    'Een script is een stuk programmacode dat wordt gebruikt om onze website goed en interactief te laten functioneren. Deze code wordt uitgevoerd op onze server of op jouw apparaat.',
  ],
  [
    /^A web beacon \(or a pixel tag\) is a small, invisible piece of text or image on a website that is used to monitor traffic on a website\. In order to do this, various data about you is stored using web beacons\.$/,
    'Een webbaken (of pixel-tag) is een klein, onzichtbaar stukje tekst of afbeelding op een website dat wordt gebruikt om het verkeer op een website te monitoren. Om dit te doen, worden diverse gegevens over je opgeslagen via webbakens.',
  ],
  [
    /^Some cookies ensure that certain parts of the website work properly and that your user preferences remain known\. By placing functional cookies, we make it easier for you to visit our website\. This way, you do not need to repeatedly enter the same information when visiting our website and, for example, the items remain in your shopping cart until you have paid\. We may place these cookies without your consent\.$/,
    'Sommige cookies zorgen ervoor dat bepaalde onderdelen van de website goed werken en dat jouw gebruikersvoorkeuren bekend blijven. Door functionele cookies te plaatsen, maken wij het voor je makkelijker om onze website te bezoeken. Zo hoeft je niet herhaaldelijk dezelfde informatie in te voeren bij een bezoek aan onze website en blijven items bijvoorbeeld in jouw winkelwagen tot je hebt betaald. Wij mogen deze cookies plaatsen zonder jouw toestemming.',
  ],
  [
    ...
    'Wij gebruiken statistiekcookies om de website-ervaring voor onze gebruikers te optimaliseren. Met deze statistiekcookies krijgen wij inzicht in het gebruik van onze website. Wij vragen jouw toestemming om statistiekcookies te plaatsen.',
  ],
  [
  ...
  [
    ...
    'Lees de privacyverklaring van deze sociale netwerken (die regelmatig kan wijzigen) om te zien wat zij doen met jouw (persoons)gegevens die zij via deze cookies verwerken. De opgehaalde gegevens worden zoveel mogelijk geanonimiseerd. Facebook, Twitter, LinkedIn, WhatsApp, Instagram, TikTok, Pinterest en Disqus zijn gevestigd in de Verenigde Staten.',
  ],
  [
    /^When you visit our website for the first time, we will show you a pop-up with an explanation about cookies\. As soon as you click on "Save preferences", you consent to us using the categories of cookies and plug-ins you selected in the pop-up, as described in this Cookie Policy\. You can disable the use of cookies via your browser, but please note that our website may no longer work properly\.$/,
    'Wanneer je onze website voor het eerst bezoekt, tonen wij je een pop-up met uitleg over cookies. Zodra je op “Voorkeuren opslaan” klikt, stemt je ermee in dat wij de categorieën cookies en plug-ins gebruiken die je in de pop-up heeft geselecteerd, zoals beschreven in dit cookiebeleid. Je kunt het gebruik van cookies via jouw browser uitschakelen, maar houd er rekening mee dat onze website dan mogelijk niet meer goed werkt.',
  ],
  [
    ...
    'Je hebt het cookiebeleid geladen zonder JavaScript-ondersteuning. Op AMP kun je de knop voor het beheren van toestemming onderaan de pagina gebruiken.',
  ],
  [
    /^You can use your internet browser to automatically or manually delete cookies\. You can also specify that certain cookies may not be placed\. Another option is to change the settings of your internet browser so that you receive a message each time a cookie is placed\. For more information about these options, please refer to the instructions in the Help section of your browser\.$/,
    'Je kunt jouw internetbrowser gebruiken om cookies automatisch of handmatig te verwijderen. Je kunt ook aangeven dat bepaalde cookies niet mogen worden geplaatst. Een andere optie is de instellingen van jouw internetbrowser te wijzigen zodat je een melding krijgt telkens wanneer een cookie wordt geplaatst. Voor meer informatie over deze opties, raadpleeg de instructies in de Help-sectie van jouw browser.',
  ],
  [
    /^Please note that our website may not work properly if all cookies are disabled\. If you do delete the cookies in your browser, they will be placed again after your consent when you visit our website again\.$/,
    'Houd er rekening mee dat onze website mogelijk niet goed werkt als alle cookies zijn uitgeschakeld. Als je de cookies in jouw browser verwijdert, worden zij na jouw toestemming opnieuw geplaatst wanneer je onze website opnieuw bezoekt.',
  ],
  [
    /^To exercise these rights, please contact us\. Please refer to the contact details at the bottom of this Cookie Policy\. If you have a complaint about how we handle your data, we would like to hear from you, but you also have the right to submit a complaint to the supervisory authority \(the Data Protection Authority\)\.$/,
    'Om deze rechten uit te oefenen, neem contact met ons op. Raadpleeg de contactgegevens onderaan dit cookiebeleid. Als je een klacht heeft over hoe wij met jouw gegevens omgaan, horen wij dat graag, maar je hebt ook het recht een klacht in te dienen bij de toezichthoudende autoriteit (de Autoriteit Persoonsgegevens).',
  ],
];
