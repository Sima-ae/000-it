  ...
  if (id === "social") {
    return nl
      ? [
          ...
          ``,
          `CTA: Wil je een korte scan op jouw setup? Stuur een DM of plan een afspraak.`,
          ``,
  ...
  if (id === "email") {
    return nl
      ? [
          ...
          ``,
          `Plan hier jouw afspraak: https://000-it.com/nl/afspraak`,
          ``,
          `Groet,`,
          `TripleZero iT`,
        ].join("\n")
