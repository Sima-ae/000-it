  ...
  "grafisch-design": mapAll(
    {
      ...
      pt: "design-grafico",
      it: "design-grafico",
      el: "grafikos-schediasmos",
      pl: "projektowanie-graficzne",
      cs: "graficky-design",
      sk: "graficky-dizajn",
      hu: "grafikai-tervezes",
      ro: "design-grafic",
      bg: "grafichen-dizajn",
      hr: "graficki-dizajn",
      sr: "graficki-dizajn",
      ...
      sq: "dizajn-grafik",
      mk: "graficki-dizajn",
      lt: "grafikos-dizainas",
      da: "grafisk-design",
      sv: "grafisk-design",
      no: "grafisk-design",
      fi: "graafinen-suunnittelu",
      uk: "grafichnyj-dyzajn",
      ru: "graficheskij-dizajn",
      tr: "grafik-tasarim",
      he: "itzuv-grafi",
      ar: "tasmim-grafiki",
      ka: "grapikuli-dizaini",
      hy: "grafikakan-dizayn",
      az: "qrafik-dizayn",
      zh: "pingmian-sheji",
      ja: "gurafikku-dezain",
    },
